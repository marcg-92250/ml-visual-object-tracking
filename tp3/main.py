"""
File name: main.py
Description: Main script for Kalman-Guided IoU Tracking
Python Version: 3.7+
"""
...
# Add utils to path (reuse from tp2)
...
from kalman_iou_tracker import IOUKalmanTracker
...
def main():
    """
    Main function for Kalman-Guided IoU tracking.
    """
    # Paths - relative to tp3 directory
    ...
    # Initialize tracker with higher max_age for better robustness
    tracker = IOUKalmanTracker(iou_threshold=0.3, max_age=10)
    ...
    print("Starting Kalman-Guided IoU tracking...")
    ...
    for frame_idx, img_file in enumerate(img_files, start=1):
        ...
        # Display frame
        cv2.imshow('Kalman-IoU Tracking', frame)
